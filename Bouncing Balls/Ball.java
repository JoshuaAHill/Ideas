...
public class Ball 
{
     ...
     */
    public void move(GameArenaOriginal game){
...
*/
    public void checkBallCollision(ArrayList<Ball> list, int ballSize, GameArenaOriginal game){
        for(int i = 0;i<list.size();i++){
            Ball collisionBall = list.get(i);
            //General area check to speed up processing - only checks rectangles that are in a given range
            if(getXPosition()<collisionBall.getXPosition()+100 && getXPosition()>collisionBall.getXPosition()-100 && getYPosition()<collisionBall.getYPosition()+100 && getYPosition()>collisionBall.getYPosition()-100){
                if(getXPosition()+size>collisionBall.getXPosition()-ballSize/2 && getXPosition()-size<collisionBall.getXPosition()+ballSize/2 && getYPosition()-size-2 < collisionBall.getYPosition()+ballSize/2 && getYPosition()>collisionBall.getYPosition() && (Math.abs(collisionBall.getXPosition() - getXPosition()) < Math.abs(collisionBall.getYPosition() - getYPosition())) && ySpeed<0){
                    ySpeed = -ySpeed; //BOTTOM
                    randCol();
                ...
                if(getYPosition()+size>collisionBall.getYPosition()-ballSize/2 && getYPosition()-size<collisionBall.getYPosition()+ballSize/2 && getXPosition()-size < collisionBall.getXPosition()+ballSize/2 && getXPosition()>collisionBall.getXPosition() && (Math.abs(collisionBall.getYPosition() - getYPosition()) < Math.abs(collisionBall.getYPosition() - getXPosition())) && xSpeed<0){
                    xSpeed = -xSpeed;  //RIGHT
                    randCol();

                    break;
                }
                if(getYPosition()+size>collisionBall.getYPosition()-ballSize/2 && (getYPosition()-size)<collisionBall.getYPosition()+ballSize/2 && getXPosition()+size > collisionBall.getXPosition()-ballSize/2 && getXPosition()<collisionBall.getXPosition() && (Math.abs(collisionBall.getYPosition() - getYPosition()) < Math.abs(collisionBall.getXPosition() - getXPosition())) && xSpeed>0){
                    xSpeed = -xSpeed; //LEFT
                    randCol();
