...
public class GameArena 
{
    ...
    private CopyOnWriteArrayList<Object> removeList = new CopyOnWriteArrayList<Object>();
    ...
    public void addGamePanel(JPanel mainPanel, GridBagConstraints c){
        mainPanel.add(jfxPanel,c);
    }
    ...
    {   
        ...
        scene = new Scene(root, arenaWidth, arenaHeight, Color.BLACK);
                System.out.println("Creating arena " + renderLock.toString() + " current Thread" + Thread.currentThread());
        renderLock.lock();
                System.out.println("Locking created Arena" + renderLock.toString()+ " current Thread" + Thread.currentThread());
...
**/
    ...
    public void lockStatus(){
        System.out.println(renderLock.toString());
    }
