 ...
 * @author Joe Finney
 */
public class GameArenaOriginal
{
	// Size of window
	...
	/**
     * Constructor. Creates an instance of the GameArenaOriginal class, and displays a window on the
     * screen upon which shapes can be drawn.
     *
     * @param width The width of the window, in pixels.
     * @param height The height of the window, in pixels.
	 */
	public GameArenaOriginal(int width, int height)
	{   
     ...
     * @param width The width of the window, in pixels.
     * @param height The height of the window, in pixels.
     * @param createWindow Determines if a JFrame containing the GameArenaOriginal should be created (true) or not (false).
	 */
	public GameArenaOriginal(int width, int height, boolean createWindow)
	{   
   ...
   private void initFX() {
	...
	/**
	 * Close this GameArenaOriginal window.
	 * 
	 */
	public void exit()
	{
	...
	/**
	 * Adds a given Ball to the GameArenaOriginal. 
	 * Once a Ball is added, it will automatically appear on the window. 
	 *
	 * @param b the ball to add to the GameArenaOriginal.
	 */
	...
	/**
	 * Remove a Ball from the GameArenaOriginal. 
	 * Once a Ball is removed, it will no longer appear on the window. 
	 *
	 * @param b the ball to remove from the GameArenaOriginal.
	 */
	...
	/**
     * Adds a given Line to the GameArenaOriginal. 
	 * Once a Line is added, it will automatically appear on the window. 
	 *
	 * @param l the Line to add to the GameArenaOriginal.
	 */
	...
	/**
	 * Remove a Line from the GameArenaOriginal. 
	 * Once a Line is removed, it will no longer appear on the window. 
	 *
	 * @param l the line to remove from the GameArenaOriginal.
	 */
	...
	/**
     * Adds the given Text to the GameArenaOriginal. 
	 * Once the Text is added, it will automatically appear on the window. 
	 *
	 * @param t the Text to add to the GameArenaOriginal.
	 */
	...
	/**
	 * Remove the given Text from the GameArenaOriginal. 
	 * Once the Text is removed, it will no longer appear on the window. 
	 *
	 * @param t the Text to remove from the GameArenaOriginal.
	 */
	...
	/**
	 * Adds a given rectangle to the GameArenaOriginal. 
	 * Once a Rectangle is added, it will automatically appear on the window. 
	 *
	 * @param r the rectangle to add to the GameArenaOriginal.
	 */
	...
	/**
	 * Remove a Rectangle from the GameArenaOriginal. 
	 * Once a Rectangle is removed, it will no longer appear on the window. 
	 *
	 * @param r the rectangle to remove from the GameArenaOriginal.
	 */
	public void removeRectangle(Rectangle r)
	{
  	...
  	/**
     * Update the window to reflect all graphical objects added to this GameArenaOriginal.
     *
	...
	/** 
	 * Gets the width of the GameArenaOriginal window, in pixels.
	...
	/** 
	 * Gets the height of the GameArenaOriginal window, in pixels.
    ...
    /** 
     * Acquires the JPanel containing this GameArenaOriginal.
     * @return The JPanel object containing this GameArenaOriginal.
     */
