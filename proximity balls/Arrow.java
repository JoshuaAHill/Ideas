...
public class Arrow 
{
    ...
    /**
     * Removes the arrow from the GameAena (game)
     * @param game  The GameArena to remove the arrow from
     */
    public void removeArrow(GameArena game){
        for(int i = 0; i<3;i++)
            game.removeLine(line[i]);
    }
     ...
     * @param arena The GameArena that the arrow should be added to
     *
     */
